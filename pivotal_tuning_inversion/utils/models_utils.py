...
def load_tuned_G(run_id, type):
    new_G_path = f'{paths_config.checkpoints_dir}/{paths_config.input_data_id}/model_{run_id}_{type}.pt'
...
def load_old_G():
    with open(paths_config.stylegan2_echo_grayscale_256, 'rb') as f:
