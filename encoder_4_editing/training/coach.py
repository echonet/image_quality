...
class Coach:
    def __init__(self, opts, prev_train_checkpoint=None):
        ...
        if self.opts.w_discriminator_lambda > 0:
            ...
            self.discriminator_optimizer = torch.optim.AdamW(list(self.discriminator.parameters()),
    ...
    def train(self):
        ...
        while self.global_step < self.opts.max_steps:
            for batch_idx, batch in enumerate(self.train_dataloader):
                ...
                x, y, y_hat = x.repeat(1,3,1,1), y.repeat(1,3,1,1), y_hat.repeat(1,3,1,1)
    ...
    def validate(self):
        ...
        for batch_idx, batch in enumerate(self.test_dataloader):
            ...
            with torch.no_grad():
                x, y, y_hat, latent = self.forward(batch)
                x, y, y_hat = x.repeat(1,3,1,1), y.repeat(1,3,1,1), y.repeat(1,3,1,1)
