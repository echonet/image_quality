...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--learning_rate', default=0.0008, type=float, help='Optimizer learning rate') # 0.0001
        ...
        self.parser.add_argument('--stylegan_weights', default=model_paths['stylegan_echo'], type=str,
        ...
        self.parser.add_argument('--progressive_step_every', type=int, default=25_000,
