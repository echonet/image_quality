...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--learning_rate', default=0.0003, type=float, help='Optimizer learning rate')
        ...
        self.parser.add_argument('--stylegan_weights', default=model_paths['EchoGAN'], type=str,
                                 help='Path to StyleGAN model weights')
        self.parser.add_argument('--stylegan_size', default=256, type=int,
                                 help='size of pretrained StyleGAN Generator')
        self.parser.add_argument('--checkpoint_path', default="TRAIN_BASE/checkpoints/best_model.pt", type=str, help='Path to pSp model checkpoint')

        self.parser.add_argument('--max_steps', default=5000000, type=int, help='Maximum number of training steps')
        ...
        self.parser.add_argument('--progressive_step_every', type=int, default=20000,
